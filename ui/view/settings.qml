...
deploy the key at the node you trust completely."*/
        ...
        onAccepted: {
            HdsGlobals.copyToClipboard(ownerKeyValue.text);
        }
                    ...
                    ColumnLayout {
                        ...
                        RowLayout {
                            ...
                            SFText {
                                ...
                                text: Style.linkStyle + qsTrId("settings-general-allow-Hdscom-label").arg(hdsUrl).arg(explorerUrl)
                                textFormat: Text.RichText
                                font.pixelSize: 14
                                color: allowHdsCOMLinks.palette.text
                            ...
                            CustomSwitch {
                                ...
                                checked: viewModel.isAllowedHdsCOMLinks
                                Binding {
                                    target: viewModel
                                    property: "isAllowedHdsCOMLinks"
                                    value: allowHdsCOMLinks.checked
                                }
                            }
                        }
                ...
                Rectangle {
                    ...
                    ColumnLayout {
                        ...
                        CustomSwitch {
                            ...
                            font.pixelSize: 14
                            Layout.fillWidth: true
                            checked: viewModel.notificationsSettings.isHdsNewsActive
                            Binding {
                                target: viewModel.notificationsSettings
                                property: "isHdsNewsActive"
                ...
                Rectangle {
                    ...
                    ColumnLayout {
                        ...
                        SFText {
                            ...
                            property string rpm2: qsTrId("settings-report-problem-message-l2").arg(hdsEmail).arg(hdsGithub)
