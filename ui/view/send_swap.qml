...
ColumnLayout {
    ...
    function validateCoin() {
        ...
        if (currency == Currency.CurrHds) {
            currency = viewModel.receiveCurrency;

            if (currency == Currency.CurrHds) return;
        }
...
*/
            swapna.text = qsTrId("swap-currency-na-message").arg(HdsGlobals.getCurrencyName(currency))
            swapna.open()
            return false;
        }
                    ...
                    GridLayout {
                        ...
                        ColumnLayout {
                            ...
                            SFText {
                                ...
                                font.pixelSize:   14
                                color:            Style.content_secondary
                                text:             Utils.formatDateTime(viewModel.offeredTime, HdsGlobals.getLocaleName())
                            }
                        }
                        ...
                        ColumnLayout {
                            ...
                            SFText {
                                ...
                                font.pixelSize:   14
                                color:            Style.content_secondary
                                text:             Utils.formatDateTime(viewModel.expiresTime, HdsGlobals.getLocaleName())
                            }
                        }
                    }
