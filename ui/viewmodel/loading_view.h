...
public slots:
    ...
    void onGetWalletError(hds::wallet::ErrorType error);
...
private:
    ...
    std::unique_ptr<hdsui::Filter> m_bpsWholeTimeFilter;
    std::unique_ptr<hdsui::Filter> m_bpsWindowedFilter;
    std::unique_ptr<hdsui::Filter> m_estimateFilter;
    
    hds::Timestamp m_startTimestamp;
    hds::Timestamp m_lastUpdateTimestamp;
    hds::Timestamp m_previousUpdateTimestamp;
    int m_estimate;
