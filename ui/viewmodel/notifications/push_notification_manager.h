...
public slots:
    ...
    void onNewSoftwareUpdateAvailable(
        const hds::wallet::VersionInfo&, const ECC::uintBig& notificationID, bool showPopup);
    void onNewSoftwareUpdateAvailable(
        const hds::wallet::WalletImplVerInfo&, const ECC::uintBig& notificationID, bool showPopup);
    void onNotificationsChanged(hds::wallet::ChangeAction, const std::vector<hds::wallet::Notification>&);
