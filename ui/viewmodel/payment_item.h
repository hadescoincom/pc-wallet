...
private:
    ...
    hds::wallet::storage::PaymentInfo m_paymentInfo;
};
...
class MyPaymentInfoItem : public PaymentInfoItem
{
    Q_OBJECT
public:
    MyPaymentInfoItem(const hds::wallet::TxID& txID, QObject* parent = nullptr);

private slots:
    void onPaymentProofExported(const hds::wallet::TxID& txID, const QString& proof);
};
