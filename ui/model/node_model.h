...
class NodeModel 
    : public QObject
    , private hds::INodeClientObserver
{
    Q_OBJECT
public:
    ...
    void setKdf(hds::Key::IKdf::Ptr);
    void setOwnerKey(hds::Key::IPKdf::Ptr);
    void startNode();
    void stopNode();
...
signals:
    ...
    void startedNode();
    void stoppedNode();
    void failedToStartNode(hds::wallet::ErrorType errorType);
    void failedToSyncNode(hds::wallet::ErrorType errorType);
    void createdNode();
    void destroyedNode();
...
protected:
    ...
    void onFailedToStartNode(hds::io::ErrorCode errorCode) override;
    void onSyncError(hds::Node::IObserver::Error error) override;
