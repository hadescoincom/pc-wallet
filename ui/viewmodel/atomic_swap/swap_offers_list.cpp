...
QHash<int, QByteArray> SwapOffersList::roleNames() const
{
    static const auto roles = QHash<int, QByteArray>
    {
        ...
        { static_cast<int>(Roles::IsSendHds), "isSendHds" },
...
QVariant SwapOffersList::data(const QModelIndex &index, int role) const
{
    ...
    switch (static_cast<Roles>(role))
    {
        ...
        case Roles::IsSendHds:
            return value->isSendHds();
        ...
        case Roles::Pair:
        {
            ...
            const QString hds = "hds";
            return  value->isSendHds() ? hds + swapCoin : swapCoin + hds;
        }
        default:
            return QVariant();
    }
