...
public:
    SwapCoinSettingsItem(SwapCoinClientModel& coinClient, hds::wallet::AtomicSwapCoin swapCoin);
...
private:
    ...
    void setConnectionType(hds::bitcoin::ISettings::ConnectionType type);
...
private:
    hds::wallet::AtomicSwapCoin m_swapCoin;
    SwapCoinClientModel& m_coinClient;

    boost::optional<hds::bitcoin::Settings> m_settings;
    int m_feeRate = 0;

    hds::bitcoin::ISettings::ConnectionType
        m_connectionType = hds::bitcoin::ISettings::ConnectionType::None;
    QString m_nodeUser;
    QString m_nodePass;
...
class SettingsViewModel : public QObject
{
    ...
    Q_PROPERTY(bool     isAllowedHdsCOMLinks    READ isAllowedHdsCOMLinks       WRITE allowHdsCOMLinks NOTIFY hdsMWLinksPermissionChanged)
...
signals:
    ...
    void hdsMWLinksPermissionChanged();
