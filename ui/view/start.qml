    ...
    ConfirmationDialog {
        ...
        contentItem: Column {
            ...
            SFText {
                ...
                width: parent.width
                //% "You are trying to restore an existing Hds Wallet. Please notice that if you use your wallet on another device, your balance will be up to date, but  transaction history and addresses will be kept separately on each device."
