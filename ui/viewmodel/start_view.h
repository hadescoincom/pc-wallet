...
public:
    ...
    using DoneCallback = std::function<bool (hds::wallet::IWalletDB::Ptr db, const std::string& walletPass)>;
...
private:
    ...
    hds::WordList m_generatedPhrases;
...
#if defined(HDS_HW_WALLET)
    std::shared_ptr<hds::wallet::HWWallet> m_hwWallet;
    ...
    hds::wallet::IPrivateKeyKeeper2::Ptr m_HWKeyKeeper;
#endif
};
