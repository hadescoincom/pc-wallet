...
Rectangle {
    ...
    PushNotificationManager {
        ...
        onShowUpdateNotification: function(newVersion, currentVersion, id) {
            ...
            popup.message = "Your current version is v" + currentVersion + ". Please update to get the most of your Hds wallet.";
        ...
        Item {
            ...
            SvgImage {
                ...
                source: whereToBuyControl.clicked
                    ? "qrc:/assets/icon-where-to-buy-hds-green.svg"
                    : "qrc:/assets/icon-where-to-buy-hds-gray.svg"
            }
            Item {
                Rectangle {
                    id: indicator
