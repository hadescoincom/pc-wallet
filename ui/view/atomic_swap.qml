        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                SwapCurrencyAmountPane {
                    ...
                    isOk: true
                    borderSize: 1
                    visible: !HdsGlobals.haveBtc() || !HdsGlobals.haveLtc() || !HdsGlobals.haveQtum()
                    MouseArea {
                        id:                clickArea
                        anchors.fill:      parent
                    ...
                    RowLayout {
                        ...
                        CustomComboBox {
                            ...
                            model: ListModel {
                                    ...
                                    ListElement{text: "HDS->BTC"; pair: "hdsbtc"}
                                    ListElement{text: "HDS->LTC"; pair: "hdsltc"}
                                    ListElement{text: "HDS->QTUM"; pair: "hdsqtum"}
                                    ListElement{text: "BTC->HDS"; pair: "btchds"}
                                    ListElement{text: "LTC->HDS"; pair: "ltchds"}
                                    ListElement{text: "QTUM->HDS"; pair: "qtumhds"}
                                }
                        }
                    }   // RowLayout
                    ...
                    CustomTableView {
                        ...
                        TableViewColumn {
                            ...
                            delegate: Item {
                                ...
                                property var isSendHds: !!model && model.isSendHds
                                        ...
                                        MouseArea {
                                            ...
                                            onClicked: {
                                                if (isOwnOffer) {
                                                    ...
                                                    var token = HdsGlobals.rawTxParametrsToTokenStr(txParameters);
                                                    tokenDuplicateChecker.checkTokenForDuplicate(token);
                                                }
                                            }
                                        }
                ...
                ColumnLayout {
                    ...
                    CustomTableView {
                        ...
                        rowDelegate: ExpandableRowDelegate {
                            ...
                            delegate: SwapTransactionDetails {
                                    ...
                                    isHdsSide:                     txRolesMap && txRolesMap.isHdsSideSwap ? txRolesMap.isHdsSideSwap : false
                                    ...
                                    hdsLockTxKernelId:             txRolesMap && txRolesMap.hdsLockTxKernelId ? txRolesMap.hdsLockTxKernelId : ""
                                    hdsRedeemTxKernelId:           txRolesMap && txRolesMap.hdsRedeemTxKernelId ? txRolesMap.hdsRedeemTxKernelId : ""
                                    hdsRefundTxKernelId:           txRolesMap && txRolesMap.hdsRefundTxKernelId ? txRolesMap.hdsRefundTxKernelId : ""
                        ...
                        TableViewColumn {
                            ...
                            delegate: Item {
                                ...
                                height: transactionsTable.rowHeight
                                property var swapCoin: styleData.value
                                property var isSendHds: !!model && model.isHdsSideSwap
                                ...
                                RowLayout {
                                    ...
                                    SvgImage {
                                        z: 1
                                        sourceSize: Qt.size(20, 20)
                                        source: isSendHds ? "qrc:/assets/icon-hds.svg" : getCoinIcon(swapCoin)
                                    }
                                    SvgImage {
                                        sourceSize: Qt.size(20, 20)
                                        source: isSendHds ? getCoinIcon(swapCoin) : "qrc:/assets/icon-hds.svg"
                                    }
                                }
                            }
                        }
                            ...
                            delegate: Item {
                                Item {
                                    ...
                                    TableItem {
                                        ...
                                        onCopyText: HdsGlobals.copyToClipboard(!!model ? model.amountSend  : "")
                                    }
                                }
                            }
                        }
                            ...
                            delegate: Item {
                                Item {
                                    ...
                                    TableItem {
                                        ...
                                        onCopyText: HdsGlobals.copyToClipboard(!!model ? model.amountReceive  : "")
                                    }
                                }
                            }
                        }
                    ...
                    ContextMenu {
                        ...
                        Action {
                            ...
                            onTriggered: {
                                HdsGlobals.copyToClipboard(txContextMenu.token);
                            }
                        }
